...
@section('content')
    <div class="row">
        <div class="col-md-8">
            ...
            <div id="back-end-comments" style="margin-top: 50px">
            ...
            <div class="well">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        {!! Form::submit('Delete', ['class'=> 'btn btn-danger btn-block confirm-box']) !!}
                        {!! Form::close() !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        {{ Html::linkRoute('posts.index', '<< See all the posts>>', [], [
